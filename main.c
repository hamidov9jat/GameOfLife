// Nijat Hamidov, Parviz Bayramli L2 Ufaz CS-19
...
//      SDL_SetRenderDrawColor(renderer, 100, 200, 100, SDL_ALPHA_OPAQUE);
      SDL_SetRenderDrawColor(renderer, 0, 255, 34, SDL_ALPHA_OPAQUE);
      if (world[x][y]) {
	SDL_Rect rect;
...
int main(int argc, char **argv) {
  ...
  font = TTF_OpenFont("C:\\Users\\User\\Documents\\c projects\\neso c\\GameOfLife\\thin_pixel-7.ttf", 36);
